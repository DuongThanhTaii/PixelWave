...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-pw-surface-300)] p-4 md:p-8">
      <div className="max-w-7xl mx-auto bg-[var(--color-pw-surface-100)] border-4 border-black p-6 rounded shadow-[8px_8px_0_0_#000]">
        <h1 className="font-display text-4xl font-bold uppercase mb-2">Admin / Mod Dashboard 🛡️</h1>
        <p className="font-body text-[var(--color-on-surface-variant)] mb-8">Welcome, {username} ({role}). Manage the universe.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* TRACKS */}
          <section className="border-2 border-black p-4 md:p-6 bg-white shadow-[4px_4px_0_0_#000]">
          ...
          <div className="flex flex-col gap-8">
            ...
            <section className="border-2 border-black p-4 md:p-6 bg-white shadow-[4px_4px_0_0_#000]">
              ...
              <form onSubmit={handleCreateArtist} className="flex flex-col gap-4 font-data text-sm">
                ...
                <textarea placeholder="Bio" rows={2} className="border-2 border-black p-2 outline-none focus:bg-gray-100" value={artistData.bio} onChange={e => setArtistData({...artistData, bio: e.target.value})} />
                ...
                <button type="submit" className="bg-[var(--color-pw-surface-100)] text-black border-2 border-black p-3 font-bold uppercase shadow-[4px_4px_0_0_#000] active:translate-y-1 active:translate-x-1 active:shadow-none">Submit Artist</button>
              </form>
            </section>
            ...
            <section className="border-2 border-black p-4 md:p-6 bg-white shadow-[4px_4px_0_0_#000]">
              ...
              <form onSubmit={handleCreateAlbum} className="flex flex-col gap-4 font-data text-sm">
                ...
                <button type="submit" className="bg-black text-white border-2 border-black p-3 font-bold uppercase shadow-[4px_4px_0_0_#000] active:translate-y-1 active:translate-x-1 active:shadow-[0px_0px_0_0_#000]">Submit Album</button>
              </form>
            </section>
            ...
            <section className="border-2 border-black p-4 md:p-6 bg-white shadow-[4px_4px_0_0_#000]">
              ...
              <form onSubmit={handleCreateFandom} className="flex flex-col gap-4 font-data text-sm">
                ...
                <button type="submit" className="bg-[var(--color-pw-vibrant-blue)] text-white border-2 border-black p-3 font-bold uppercase shadow-[4px_4px_0_0_#000] active:translate-y-1 active:translate-x-1 active:shadow-none">Submit Fandom</button>
              </form>
            </section>
            ...
            <section className="border-2 border-black p-4 md:p-6 bg-white shadow-[4px_4px_0_0_#000]">
              ...
              <form onSubmit={handleUpdateRole} className="flex flex-col gap-4 font-data text-sm">
                ...
                <button type="submit" disabled={role !== 'ADMIN'} className="bg-gray-800 text-white border-2 border-black p-3 font-bold uppercase shadow-[4px_4px_0_0_#000] active:translate-y-1 active:translate-x-1 active:shadow-none disabled:opacity-50">Update Role</button>
                {role !== 'ADMIN' && <p className="text-xs text-red-600">Requires ADMIN role</p>}
              </form>
            </section>
